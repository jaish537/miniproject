...
<body>
    ...
    <p><strong>Student Name:</strong> Student 1</p>
    <p><strong>Practical:</strong> Practical 1</p>
    ...
    <form action="#" method="post">
        ...
        <button type="submit" name="status" value="CHECKED">
            Approve / Mark Checked
        </button>

        <button type="submit" name="status" value="RESUBMIT">
